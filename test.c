...
{  
    ...
    /*cout<<*/printf("输入页面数:");/*<<endl;*/  
    cin>>pageCount;  
    int *pc=new int[pageCount];  
    /*cout<<*/printf("输入页面走向:");/*<<endl;*/  
    for(i=0;i<pageCount;i++)  
    {  
        cin>>pc[i];  
    }  
    /*cout<<*/printf("输入物理块数:");/*<<endl;*/ 
    cin>>blockCount;  
    cout<<"0：先进先出置换算法"<<endl;  
    cout<<"1：最近最久未使用算法"<<endl;  
    cout<<"2：最佳置换算法"<<endl;  
    cout<<"3：时钟页面置换算法"<<endl;  
    /*cout<<*/printf("按数字选择算法类别:");/*<<endl;*/   
    int n;  
    while(cin>>n)  
    {  
        if(n==0)  
